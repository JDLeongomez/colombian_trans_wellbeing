...
dredge.plot <- function(mod.sel.table) {
  ...
  caption <- paste0(
    ...
    " to each model’s relative support based on its Akaike weight ($\\\\omega$)"
  )
...
The plot below visualizes the model selection results, displaying the top 100 models ranked by $AICc$. Each row represents an individual model, with blue cells indicating included predictors. The height of each row reflects the model’s Akaike weight ($\omega$), representing its relative support in the model set.
